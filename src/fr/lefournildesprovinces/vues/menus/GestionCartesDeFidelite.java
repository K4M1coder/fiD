...
public class GestionCartesDeFidelite extends JFrame {
	...
	public GestionCartesDeFidelite() {
		...
		GestionCartesDeFidelite.this.lblMerciDeFaire.setEnabled(false);
		GestionCartesDeFidelite.this.lblValider.setVisible(false);
		GestionCartesDeFidelite.this.lblValider.setEnabled(false);
		GestionCartesDeFidelite.this.comboBox.setVisible(false);
		GestionCartesDeFidelite.this.comboBox.setEnabled(false);
	}
