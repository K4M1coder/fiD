...
import fr.lefournildesprovinces.vues.Selectionutilisateur;
import fr.lefournildesprovinces.vues.newuser;
...
public class Utilisateurs extends JFrame {
	...
	public Utilisateurs() {
		...
		Utilisateurs.this.lblMerciDeFaire.setVisible(false);
		Utilisateurs.this.lblMerciDeFaire.setEnabled(false);
		Utilisateurs.this.valider.setVisible(false);
		Utilisateurs.this.valider.setEnabled(false);
		Utilisateurs.this.comboBox.setVisible(false);
		Utilisateurs.this.comboBox.setEnabled(false);
	}
		...
		if (this.comboBox == null) {
			...
			this.comboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(final ActionEvent arg0) {
					...
					try {
						Utilisateurs.this.selection = Utilisateurs.this.comboBox
								.getSelectedItem().toString().substring(1);
						Utilisateurs.this.valider.setVisible(true);
						Utilisateurs.this.lblMerciDeFaire.setVisible(false);

					} catch (final Exception e1) {
						final String message = "Choix Impossible - Merci de vérifier votre sélection";
						final AlerteSelection fenetre = new AlerteSelection(
								Utilisateurs.this.interfaceActuelle, message);
						fenetre.setVisible(true);
						Utilisateurs.this.interfaceActuelle.setEnabled(false);
						Utilisateurs.this.interfaceActuelle.setVisible(false);
						Utilisateurs.this.valider.setVisible(false);
						Utilisateurs.this.valider.setEnabled(false);
						Utilisateurs.this.lblMerciDeFaire.setVisible(true);
	...
	private JLabel getFond() {
		if (this.fond == null) {
			...
			this.fond.setIcon(new ImageIcon(Utilisateurs.class
	...
	private JLabel getLabel_ADMNewProfil() {
		if (this.label_ADMNewProfil == null) {
			...
			this.label_ADMNewProfil.setIcon(new ImageIcon(Utilisateurs.class.getResource("/Images/menubutons/bouton-admin-creer-profil.png")));
			...
			this.label_ADMNewProfil.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					Utilisateurs.this.selection="CREER un profil utilisateur";
					validateAction();
				}
			});
	...
	private JLabel getLabel_ADMModPassword() {
		if (this.label_ADMModPassword == null) {
			...
			this.label_ADMModPassword.setIcon(new ImageIcon(Utilisateurs.class.getResource("/Images/menubutons/bouton-admin-maj-mot-pass.png")));
			...
			this.label_ADMModPassword.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					Utilisateurs.this.selection="METTRE A JOUR un mot de passe utilisateur";
					validateAction();
				}
			});
	...
	private JLabel getLabel_ADMDelUser() {
		if (this.label_ADMDelUser == null) {
			...
			this.label_ADMDelUser.setIcon(new ImageIcon(Utilisateurs.class.getResource("/Images/menubutons/bouton-admin-supp-profil.png")));
			...
			this.label_ADMDelUser.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					Utilisateurs.this.selection="SUPPRIMER un utilisateur";
					validateAction();
				}
			});
	...
	private JLabel getLabel_ADMMajPrivilege() {
		if (this.label_ADMMajPrivilege == null) {
			...
			this.label_ADMMajPrivilege.setIcon(new ImageIcon(Utilisateurs.class.getResource("/Images/menubutons/bouton-admin-maj-privileges.png")));
			...
			this.label_ADMMajPrivilege.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					Utilisateurs.this.selection="METTRE A JOUR un privilege utilisateur";
					validateAction();
				}
			});
	...
	private JLabel getLabel_ADMShowUser() {
		if (this.label_ADMShowUser == null) {
			...
			this.label_ADMShowUser.setIcon(new ImageIcon(Utilisateurs.class.getResource("/Images/menubutons/bouton-admin-consulte-fiche.png")));
			...
			this.label_ADMShowUser.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					Utilisateurs.this.selection="CONSULTER une fiche utilisateur";
					validateAction();
				}
			});
	...
	private JLabel getLblNewLabel() {
		if (this.lblNewLabel == null) {
			...
			this.lblNewLabel.setIcon(new ImageIcon(Utilisateurs.class
	...
	private JLabel getValider() {
		if (this.valider == null) {
			...
			this.valider.setIcon(new ImageIcon(Utilisateurs.class
	...
	private void validateAction() {
		...
		System.out.print(Utilisateurs.this.selection);
		switch (Utilisateurs.this.selection){
		case "METTRE A JOUR un mot de passe utilisateur":
			final Selectionutilisateur fenetre = new Selectionutilisateur(
					Utilisateurs.this.selection);
			fenetre.setVisible(true);
			Utilisateurs.this.dispose();
			break;
