...
import fr.lefournildesprovinces.vues.opcom.GestionOperationCommerciale2;
...
public class GestionOperationsCommerciales extends JFrame {
	...
	public GestionOperationsCommerciales() {
		...
		GestionOperationsCommerciales.this.lblValider.setEnabled(false);
		GestionOperationsCommerciales.this.comboBox.setVisible(false);
		GestionOperationsCommerciales.this.comboBox.setEnabled(false);
		...
		if (this.comboBox == null) {
			...
			this.comboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(final ActionEvent e) {
					try {
						GestionOperationsCommerciales.this.selection = GestionOperationsCommerciales.this.comboBox
								.getSelectedItem().toString();
						if (!selection.isEmpty()) {
							GestionOperationsCommerciales.this.lblMerciDeFaire
									.setVisible(false);
							GestionOperationsCommerciales.this.lblValider.setVisible(true);
						} else {
							GestionOperationsCommerciales.this.lblMerciDeFaire
									.setVisible(true);
							GestionOperationsCommerciales.this.lblValider.setVisible(false);
						...
						final AlerteSelection fenetre = new AlerteSelection(
								GestionOperationsCommerciales.this.interfaceActuelle, message);
						fenetre.setVisible(true);
						GestionOperationsCommerciales.this.interfaceActuelle.setEnabled(false);
						GestionOperationsCommerciales.this.interfaceActuelle.setVisible(false);
						GestionOperationsCommerciales.this.lblMerciDeFaire.setVisible(true);
						GestionOperationsCommerciales.this.lblValider.setVisible(false);
						GestionOperationsCommerciales.this.lblValider.setEnabled(false);
		...
		if (this.label == null) {
			...
			this.label.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					fenetre.setVisible(true);
					GestionOperationsCommerciales.this.dispose();
				}
			});
			this.label
	...
	private JLabel getlabel_BuletinParticipation() {
		if (this.label_BuletinParticipation == null) {
			...
			this.label_BuletinParticipation.setIcon(new ImageIcon(GestionOperationsCommerciales.class.getResource("/Images/menubutons/bouton-operations-saisie.png")));
			...
			this.label_BuletinParticipation.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					GestionOperationsCommerciales.this.selection="BULLETIN PARTICIPATION (Saisie, MAJ ou Suppression)";
					validateAction();
				}
			});
	...
	private JLabel getLabel_GestionOC() {
		if (this.label_GestionOC == null) {
			...
			this.label_GestionOC.setIcon(new ImageIcon(GestionOperationsCommerciales.class.getResource("/Images/menubutons/bouton-operations-gestion.png")));
			...
			this.label_GestionOC.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					GestionOperationsCommerciales.this.selection="GESTION OPERATIONS (Création, MAJ ou Suppression)";
					validateAction();
				}
			});
	...
	private void validateAction() {
		...
		switch (GestionOperationsCommerciales.this.selection) {
