...
import fr.lefournildesprovinces.vues.magasins.NouveauMagasin;
import fr.lefournildesprovinces.vues.magasins.SelectionMagasin;
...
public class GestionMagasins extends JFrame {
	...
	public GestionMagasins() {
		...
		GestionMagasins.this.lblValider.setEnabled(false);
		GestionMagasins.this.comboBox.setVisible(false);
		GestionMagasins.this.comboBox.setEnabled(false);
		...
		if (this.comboBox == null) {
			...
			this.comboBox.addActionListener(new ActionListener() {
				...
				public void actionPerformed(final ActionEvent e) {
					try {
						GestionMagasins.this.selection = GestionMagasins.this.comboBox
								.getSelectedItem().toString();
						if (!selection.isEmpty()) {
							GestionMagasins.this.lblValider.setVisible(true);
							GestionMagasins.this.lblMerciDeFaire
									.setVisible(false);
						} else {
							GestionMagasins.this.lblValider.setVisible(false);
							GestionMagasins.this.lblMerciDeFaire
						...
						final AlerteSelection fenetre = new AlerteSelection(
								GestionMagasins.this.interfaceActuelle, message);
						fenetre.setVisible(true);
						GestionMagasins.this.interfaceActuelle.setEnabled(false);
						GestionMagasins.this.interfaceActuelle.setVisible(false);
						GestionMagasins.this.lblValider.setVisible(false);
						GestionMagasins.this.lblMerciDeFaire.setVisible(true);
	...
	private JLabel getLabel_NewMag() {
		if (this.label_NewMag == null) {
			...
			this.label_NewMag.setIcon(new ImageIcon(GestionMagasins.class.getResource("/Images/menubutons/bouton-magasin-nouveau.png")));
			this.label_NewMag
			...
			this.label_NewMag.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					GestionMagasins.this.selection="NOUVEAU Magasin";
					validateAction();
				}
			});
	...
	private JLabel getLabel_ModMag() {
		if (this.label_ModMag == null) {
			...
			this.label_ModMag.setIcon(new ImageIcon(GestionMagasins.class.getResource("/Images/menubutons/bouton-magasin-mise-jour.png")));
			this.label_ModMag
					.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			...
			this.label_ModMag.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					GestionMagasins.this.selection="METTRE A JOUR un Magasin";
					validateAction();
				}
			});
	...
	private JLabel getLabel_DelMag() {
		if (this.label_DelMag == null) {
			...
			this.label_DelMag.setIcon(new ImageIcon(GestionMagasins.class.getResource("/Images/menubutons/bouton-magasin-suppression.png")));
			this.label_DelMag
					.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			...
			this.label_DelMag.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(final MouseEvent e) {
					...
					GestionMagasins.this.selection="SUPPRIMER un Magasin";
					validateAction();
				}
			});
	...
	private void validateAction() {
		...
		switch (GestionMagasins.this.selection) {
		...
		case "2": case "METTRE A JOUR un Magasin":
			...
			final SelectionMagasin fenetre = new SelectionMagasin(
					GestionMagasins.this.selection);
			fenetre.setVisible(true);
			GestionMagasins.this.dispose();
			break;
